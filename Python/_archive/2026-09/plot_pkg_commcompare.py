...
OUT_DIR = os.path.normpath(os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", "..", "..", "figures", "pkg_v1"))

RUNS = {
    'commON': {
        42: '20260619_135040_pkg_commON_s42',
        43: '20260619_135045_pkg_commON_s43',
        44: '20260619_135050_pkg_commON_s44',
    },
    'commOFF': {
        42: '20260619_135055_pkg_commOFF_s42',
        43: '20260619_135100_pkg_commOFF_s43',
        44: '20260619_135105_pkg_commOFF_s44',
    },
}
SEEDS = [42, 43, 44]
...
def main():
    ...
    fig.suptitle('pkg: commON vs commOFF  (3-seed paired, convergence = last 25% episodes, '
                 'mean +- 95%CI across seeds, no correction)', fontsize=12)
    fig.tight_layout(rect=[0, 0, 1, 0.95])

    png = os.path.join(OUT_DIR, 'pkg_commcompare_5panels.png')
