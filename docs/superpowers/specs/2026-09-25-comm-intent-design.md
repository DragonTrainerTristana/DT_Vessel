...
- 시드 43·44·45 (2026-09-26 저자 확정, 결과 전)
- 판정: 같은 trunk 짝 시드별 승패 + 평균차 + OFF 시드 범위. 주장은 3/3 승이고 평균차 > OFF 범위일 때만
...
1. ~~시드~~ → **확정 2026-09-26: 3시드(43·44·45)** (저자). 의도 가치처럼 MDE(vColl ≈6 pp) 보다 작은 차이는 '판정 불가' 로 보고
...
- 2026-09-26 저자 확정(결과 전): 3시드 43·44·45
